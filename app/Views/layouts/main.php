    ...
    <div class="modal-card modal-card-wide abtc-card" role="dialog" aria-labelledby="modalPortalTitle">
      ...
      <div class="portal-tab-content" id="registerTab">
        ...
        <form class="modal-form" id="corporateOnboardingForm" novalidate>
          ...
          <div id="onboardingStep1">
            ...
            <div class="form-row">
              <div class="form-group">
                <label for="regCompanyEmail">Correo Electrónico Corporativo *</label>
                <input type="email" id="regCompanyEmail" class="abtc-input" required placeholder="contacto@empresa.com">
                <span class="input-feedback-msg" id="emailFeedback">Debe ser un dominio propio (no @gmail, @hotmail, etc.)</span>
              </div>
              <div class="form-group">
      ...
      <div class="portal-tab-content" id="statusTab">
        <form class="modal-form" id="checkStatusForm">
          <div class="form-group">
            <label for="statusQueryInput">Ingresa CUIT de la Empresa o Correo Corporativo *</label>
            <input type="text" id="statusQueryInput" class="abtc-input" required placeholder="Ej: 30-68934512-9 o admin@bioplasticoscuyo.com.ar">
    ...
    <div class="modal-card modal-card-wide abtc-card" role="dialog" aria-labelledby="verifModalTitle">
        ...
        <div class="timeline-step completed" id="timeStep1">
          ...
          <div class="timeline-step-content">
            <div class="timeline-step-title">
              <span>1. Recepción de Datos & Dominio Corporativo</span>
              <span class="timeline-step-badge badge-success">COMPLETADO</span>
            </div>
            <p class="timeline-step-desc">Datos fiscales, correo corporativo institucional y representante validados en origen.</p>
          </div>
        </div>
      ...
      <div class="modal-actions modal-actions-between" style="border-top: 1px solid var(--color-navy-border-subtle); padding-top: 1.25rem;">
        ...
        <div style="display: flex; gap: 0.5rem;">
          <button type="button" class="btn btn-ghost btn-abtc-outline btn-sm" id="simulateAuditorApprovalBtn" title="Aprobar instantáneamente para probar como evaluador">
            ⚡ Simular Homologación Auditor
          </button>
